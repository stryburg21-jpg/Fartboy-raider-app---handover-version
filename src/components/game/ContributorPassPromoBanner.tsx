...
export function ContributorPassPromoBanner({
  variant = "hero",
  headline = "⚡ UNLOCK MONTHLY VAULT PACK DROPS",
  subtext = "Power the ecosystem and get rewarded! Higher Contributor Tiers unlock bigger monthly pack allocations, exclusive specialist loot, and permanent XP multipliers.",
  className = "",
  ...
  if (variant === "compact") {
    return (
      ...
      >
        ...
        <Link to="/contributor-pass" className="shrink-0">
          <Button
            size="sm"
          ...
          >
            <span>EXPLORE CONTRIBUTOR TIERS & PERKS ➔</span>
          </Button>
        </Link>
      </div>
    );
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <Link to="/contributor-pass" className="shrink-0 self-start sm:self-auto">
            <Button
              size="lg"
            ...
            >
              ...
              <span className="relative">[ EXPLORE CONTRIBUTOR TIERS & PERKS -&gt; ]</span>
            </Button>
          </Link>
        </div>
      </div>
      ...
      <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1.5 max-w-2xl">
          <div className="inline-flex items-center gap-1.5 rounded-full border border-amber-500/40 bg-amber-500/15 px-3 py-1 font-mono text-xs font-black text-amber-300 shadow-sm">
            <HeartHandshake className="h-3.5 w-3.5" /> Support the Ecosystem • Unlock Vault
            Allocations
          </div>
